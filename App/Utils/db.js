...
function executeQuery(query) {
    ...
    return new Promise(function (res, rej) {
        try {
            pool.connect(function (err, client, release) { return __awaiter(_this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = res;
                            return [4 /*yield*/, clientQuery(client, query, release)];
                        case 1:
...
function clientQuery(client, query, release) {
    return new Promise(function (res, rej) {
